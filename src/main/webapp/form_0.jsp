...
<%--    <form action="<%= isEdit ? "/nft/update" : "/nft/create" %>" method="post">--%>
<%--        <% if (isEdit) { %>--%>
...
<%--                   value="<%= isEdit ? nft.getName() : "" %>">--%>
<%--        </div>--%>

<%--        <!-- Description -->--%>
<%--        <div class="mb-3">--%>
<%--            <label for="description" class="form-label fw-semibold">Description</label>--%>
<%--            <textarea id="description" name="description"><%= isEdit ? nft.getDescription() : "" %></textarea>--%>
<%--        </div>--%>
...
<%--                   value="<%= isEdit ? nft.getImageUrl() : "" %>">--%>

<%--            <!-- Image preview -->--%>
<%--            <img id="image-preview"--%>
<%--                 src="<%= isEdit && nft.getImageUrl() != null ? nft.getImageUrl() : "" %>"--%>
<%--                 style="<%= isEdit && nft.getImageUrl() != null ? "display:block;" : "display:none;" %>"--%>
<%--                 alt="Preview">--%>

<%--            <div class="mt-2">--%>
<%--                <button type="button" id="upload-btn" class="btn btn-outline-primary btn-sm">--%>
<%--                    Upload Image--%>
<%--                </button>--%>
<%--                <button type="button" id="clear-btn" class="btn btn-outline-secondary btn-sm ms-2">--%>
<%--                    Clear--%>
<%--                </button>--%>
<%--            </div>--%>
<%--        </div>--%>
...
<%--                   value="<%= isEdit ? nft.getWalletAddress() : "" %>">--%>
<%--        </div>--%>
...
<%--    const cloudName = "xuanhung2401"; // 🔸 Replace with your Cloudinary cloud name--%>
<%--    const uploadPreset = "ufx1h3qp";  // 🔸 Replace with your upload preset--%>
...
<%!
    // ✅ Helper method to safely get parameter value or fallback
    public String getValue(javax.servlet.http.HttpServletRequest request, String paramName, String defaultVal) {
